...
Merchant::Merchant(int happinessLevel, ResourceManager* resourceManager, int foodConsumption)
    : Citizen(happinessLevel), resourceManager(resourceManager), foodConsumption(foodConsumption) {
}
